...
def load_data(kdataset, kfold, data_path):
    if kdataset == 0:
        mat = scipy.io.loadmat(data_path + 'ripley_5fold.mat')
    if kdataset == 1:
        mat = scipy.io.loadmat(data_path + 'kwok_5fold.mat')
    if kdataset == 2:
        mat = scipy.io.loadmat(data_path + 'twonorm_5fold.mat')
    if kdataset == 3:
        mat = scipy.io.loadmat(data_path + 'waveform_5fold.mat')
